...
| [`extract_ffpp.log`](extract_ffpp.log) | 85 | — | FaceForensics++ frame extraction / face-crop cache build (FFPP pipeline).  **(still being written)** |
| [`ffpp_prepare.log`](ffpp_prepare.log) | 10 | — | FFPP prepare step: scan tree, identity grouping, shard plan.  **(still being written)** |
| [`ffpp_shard0.log`](ffpp_shard0.log) | 6 | — | FFPP train/eval shard 0.  **(locked / not rewritten: [Errno 13] Permission denied: 'C:\\Users\\USER\\Downloads\\PostDoc\\Implimentation_Paper1\\logs\\ffpp_shard0.log')** |
| [`ffpp_shard1.log`](ffpp_shard1.log) | 6 | — | FFPP train/eval shard 1.  **(locked / not rewritten: [Errno 13] Permission denied: 'C:\\Users\\USER\\Downloads\\PostDoc\\Implimentation_Paper1\\logs\\ffpp_shard1.log')** |
| [`ffpp_shard2.log`](ffpp_shard2.log) | 6 | — | FFPP train/eval shard 2.  **(locked / not rewritten: [Errno 13] Permission denied: 'C:\\Users\\USER\\Downloads\\PostDoc\\Implimentation_Paper1\\logs\\ffpp_shard2.log')** |
| [`ffpp_shard3.log`](ffpp_shard3.log) | 6 | — | FFPP train/eval shard 3.  **(locked / not rewritten: [Errno 13] Permission denied: 'C:\\Users\\USER\\Downloads\\PostDoc\\Implimentation_Paper1\\logs\\ffpp_shard3.log')** |
| [`ffpp_shard4.log`](ffpp_shard4.log) | 6 | — | FFPP train/eval shard 4.  **(locked / not rewritten: [Errno 13] Permission denied: 'C:\\Users\\USER\\Downloads\\PostDoc\\Implimentation_Paper1\\logs\\ffpp_shard4.log')** |
| [`ffpp_shard5.log`](ffpp_shard5.log) | 6 | — | FFPP train/eval shard 5.  **(locked / not rewritten: [Errno 13] Permission denied: 'C:\\Users\\USER\\Downloads\\PostDoc\\Implimentation_Paper1\\logs\\ffpp_shard5.log')** |
| [`ffpp_shard6.log`](ffpp_shard6.log) | 6 | — | FFPP train/eval shard 6.  **(locked / not rewritten: [Errno 13] Permission denied: 'C:\\Users\\USER\\Downloads\\PostDoc\\Implimentation_Paper1\\logs\\ffpp_shard6.log')** |
| [`ffpp_shard7.log`](ffpp_shard7.log) | 6 | — | FFPP train/eval shard 7.  **(locked / not rewritten: [Errno 13] Permission denied: 'C:\\Users\\USER\\Downloads\\PostDoc\\Implimentation_Paper1\\logs\\ffpp_shard7.log')** |
